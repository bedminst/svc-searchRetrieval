 ...
 *
 */
public class CccWrMediaContext extends DefaultCoreMediaContext
{
	public static interface ProviderKeys
	{
		public static final String WR = "CCCWR";
	}

	// Provider Values
	public static final ProviderValue PROV_WR = 	  new ProviderValue(ProviderKeys.WR);
